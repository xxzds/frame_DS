...
public class YuiCompressorUtils {
    ...
    public static String compress(final String fileName) {
        ...
        Writer out = null;
        try {
            in = new BufferedReader(new InputStreamReader(new FileInputStream(fileName), Constants.UTF8));
            out = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(minFileName), Constants.UTF8));
