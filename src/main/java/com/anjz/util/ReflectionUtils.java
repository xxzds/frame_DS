...
//		System.out.println(ReflectionUtils.getSuperClassGenricType(B.class));
...
//			list.add(user);
//		}
//		System.out.println(ReflectionUtils.convertElementPropertyToList(list, "userId"));
		
//		System.out.println(ReflectionUtils.convertStringToObject("12121", Integer.class));
		
//		ReflectionUtils.getNewInstance(B.class);
	}
}