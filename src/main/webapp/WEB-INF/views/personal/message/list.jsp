...
<div data-table="table" class="panel"  data-state="${state}" data-state-info="${state.info}">
    ...
    <ul class="nav nav-tabs">
        <c:forEach items="${states}" var="s">
            ...
            <li ${s eq state ? 'class="active"' : ''}>
                <a href="${ctx}/personal/message/${s}/list">
    ...
    <div class="row-fluid tool ui-toolbar">
        <div class="span4">
            <div class="btn-group">
            	<c:if test="${state == 'out_box' }">
            		<a class="btn no-disabled" href="${ctx}/personal/message/send">
...
<es:contentFooter/>
<%@include file="/WEB-INF/views/common/admin/import-personal-js.jspf"%>
<script type="text/javascript">
    $(function() {
        $.personal.message.initListBtn();
    });
</script>
