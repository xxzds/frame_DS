...
<div class="panel">
    ...
    <ul class="nav nav-tabs">
            <c:if test="${op eq '发送草稿'}">
                <li class="active">
                    <a href="${ctx}/personal/message/draft/${m.id}/send?BackURL=<es:BackURL/>">
            ...
            <c:if test="${op eq '发送新消息'}">
                <li class="active">
                    <a href="${ctx}/personal/message/send?BackURL=<es:BackURL/>">
                        <i class="icon-file-alt"></i>
                        ${op}
                    </a>
                </li>
            ...
            <c:if test="${op eq '回复消息'}">
                <li class="active">
                    <a href="${ctx}/personal/message/${parent.id}/reply?BackURL=<es:BackURL/>">
                        <i class="icon-file-alt"></i>
                        ${op}
                    </a>
                </li>
            ...
            <c:if test="${op eq '转发消息'}">
                <li class="active">
                    <a href="${ctx}/personal/message/${parent.id}/forward?BackURL=<es:BackURL/>">
                        <i class="icon-file-alt"></i>
                            ${op}
                    </a>
                </li>
    ...
    <form:form id="editForm" method="post" commandName="m" cssClass="form-horizontal form-small">
            ...
            <div class="control-group">
                ...
                <div id="search-receiver" class="controls">
                    ...
                    <input type="text" id="receiverId_msg" name="receiver" value="${receiver}" placeholder="输入收件人用户名" class="validate[required]">
                </div>
            </div>
            </c:if>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <form:textarea id="content" path="content" data-promptPosition="topRight:-200" cssStyle="width: 680px;height: 300px;" />
                </div>
            </div>
