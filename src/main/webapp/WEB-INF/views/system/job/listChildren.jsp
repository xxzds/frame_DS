...
<div data-table="table" class="panel">
    ...
    <ul class="nav nav-tabs">
        ...
        <li>
            <a href="${ctx}/system/job/${parent.id}/update">
        ...
        <div class="span4">
            <div class="btn-group">
                <shiro:hasPermission name="system:job:create">
                    <a class="btn btn-custom no-disabled" href="${ctx}/system/job/${parent.id}/appendChild?BackURL=<es:BackURL/>">
