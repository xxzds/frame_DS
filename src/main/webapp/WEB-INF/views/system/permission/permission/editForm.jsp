    ...
    <ul class="nav nav-tabs">
        <c:if test="${op eq '新增'}">
            <li ${op eq '新增' ? 'class="active"' : ''}>
                <a href="${ctx}/system/permission/permission/create?BackURL=<es:BackURL/>">
        ...
        <c:if test="${not empty m.id}">
            <li ${op eq '查看' ? 'class="active"' : ''}>
                <a href="${ctx}/system/permission/permission/${m.id}?BackURL=<es:BackURL/>">
                    <i class="icon-eye-open"></i>
                    查看
                </a>
            </li>
            <li ${op eq '修改' ? 'class="active"' : ''}>
                <a href="${ctx}/system/permission/permission/${m.id}/update?BackURL=<es:BackURL/>">
                    <i class="icon-edit"></i>
                    修改
                </a>
            </li>
            <li ${op eq '删除' ? 'class="active"' : ''}>
                <a href="${ctx}/system/permission/permission/${m.id}/delete?BackURL=<es:BackURL/>">
        ...
        <c:choose>
            ...
            <c:otherwise>
                ...
                $.validationEngineLanguage.allRules.ajaxNameCall= {
                    "url": "${ctx}/system/permission/permission/validate",
                    //动态提取的数据。验证时一起发送
                    extraDataDynamic : ['#id'],
                    //验证失败时的消息
