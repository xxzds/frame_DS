...
<form:form id="appendChildForm" method="post" commandName="child" cssClass="form-horizontal">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <maintain:showIcon iconIdentity="${parent.iconByDefault}"/>
                 ${parent.name}
            </div>
        </div>
...
$(function () {
	//初始化“是否显示”
	$("input:radio[name='isShow']").eq(0).attr("checked","checked");
