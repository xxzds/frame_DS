...
<c:if test="${not empty cacheManager }">	
    ...
    <table class="table table-bordered">
        ...
        <tr class="bold info">
            <td colspan="2">
            ${cacheName}
            <a href="${ctx}/monitor/ehcache/${cacheName}/details" class="btn btn-link no-padding pull-right">详细</a>
            </td>
        </tr>
