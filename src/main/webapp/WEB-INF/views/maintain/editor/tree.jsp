...
<ul class="nav nav-tabs">
    <li class="active">
        <a href="${ctx}/maintain/editor/tree?async=${not empty param.async and param.async eq true}">
            ...
            setting : {
                ...
                callback : {
                    onClick: function(event, treeId, treeNode, clickFlag) {
                        parent.frames['listFrame'].location.href='${ctx}/maintain/editor/list?path=' + treeNode.path;
                    }
                }
            }
        });
