    ...
    user : {
        ...
        initUserListButton : function() {
            $(".change-password").click(function() {
                ...
                var id = checkbox.val();
                var url = ctx + "/system/user/changePassword?" + checkbox.serialize();
            ...
            $(".block-user,.unblocked-user").click(function() {
                ...
                var url = ctx + "/system/user/changeStatus/" + status + "?" + checkbox.serialize();
            ...
            $(".status-history").click(function() {
                ...
                var url = ctx + "/system/user/statusHistory?search.user_id|in=" + ids;
            ...
            $(".recycle").click(function() {
                ...
                var url = ctx + "/system/user/recycle?" + checkbox.serialize();
                $.app.confirm({
                    title : "欢迎删除的用户",
                    message : "确认还原吗？",
                    ok : function() {
        ...
        initOnlineListButton : function() {
            $(".btn-force-logout").click(function() {
                ...
                $.app.confirm({
                    message : "确认强制退出吗？",
                    ok : function() {
                        var url = ctx + "/system/user/online/forceLogout?" + checkbox.serialize();
                        window.location.href = url;
                    }
                });
            });
